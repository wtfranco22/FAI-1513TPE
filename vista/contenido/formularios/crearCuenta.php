        ...
        <div class="bg-light p-5">
            ...
            <div class="form-group">
                <div class="m-2 input-group">
                    ...
                    <button type="button" id="ojo" class="btn btn-dark fa fa-eye-slash" oninput="compararContra()" onclick="mostrarClave('clave2')"></button>
                    
                </div>
                <span id="aviso" class="text-danger"></span>
            </div>
            <div>
                <button type="submit" class="m-2 btn btn-success btn-block shadow" onclick="encriptarPass('clave'),encriptarPass('clave2')">Registrarse</button>
