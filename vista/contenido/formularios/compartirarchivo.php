...
if (isset($_GET['id'])) {
    //siempre vamos a tener el ID ya que debimos seleccionar un archivo antes de compartir
    $idarchivo = $_GET['id'];
} else {
    header("Location:ingresarCuenta.php");
}
...
<div class="border border-light m-3 shadow">
    ...
    <form class="m-5" id="compartirarchivo" name="compartirarchivo" action="../acciones/accionCompartir.php" method="POST" data-toggle="validator">
